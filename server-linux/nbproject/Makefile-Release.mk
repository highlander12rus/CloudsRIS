...
# CC Compiler Flags
CCFLAGS=-lmysqlcppconn -lboost_system -lboost_thread -lboost_serialization
CXXFLAGS=-lmysqlcppconn -lboost_system -lboost_thread -lboost_serialization
...
${OBJECTDIR}/DataBase/SingletoneConn.o: DataBase/SingletoneConn.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -lmysqlcppconn -lboost_system -lboost_thread -lboost_serialization -MMD -MP -MF $@.d -o ${OBJECTDIR}/DataBase/SingletoneConn.o DataBase/SingletoneConn.cpp

${OBJECTDIR}/DataBase/Tables/AddressBlocks.o: DataBase/Tables/AddressBlocks.cpp 
	${MKDIR} -p ${OBJECTDIR}/DataBase/Tables
	${RM} $@.d
	$(COMPILE.cc) -O2 -lmysqlcppconn -lboost_system -lboost_thread -lboost_serialization -MMD -MP -MF $@.d -o ${OBJECTDIR}/DataBase/Tables/AddressBlocks.o DataBase/Tables/AddressBlocks.cpp

${OBJECTDIR}/DataBase/Tables/Blocks.o: DataBase/Tables/Blocks.cpp 
	${MKDIR} -p ${OBJECTDIR}/DataBase/Tables
	${RM} $@.d
	$(COMPILE.cc) -O2 -lmysqlcppconn -lboost_system -lboost_thread -lboost_serialization -MMD -MP -MF $@.d -o ${OBJECTDIR}/DataBase/Tables/Blocks.o DataBase/Tables/Blocks.cpp

${OBJECTDIR}/DataBase/Tables/SecurityMethod.o: DataBase/Tables/SecurityMethod.cpp 
	${MKDIR} -p ${OBJECTDIR}/DataBase/Tables
	${RM} $@.d
	$(COMPILE.cc) -O2 -lmysqlcppconn -lboost_system -lboost_thread -lboost_serialization -MMD -MP -MF $@.d -o ${OBJECTDIR}/DataBase/Tables/SecurityMethod.o DataBase/Tables/SecurityMethod.cpp
...
${OBJECTDIR}/FileSystem/AllocatedBlocks.o: FileSystem/AllocatedBlocks.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -lmysqlcppconn -lboost_system -lboost_thread -lboost_serialization -MMD -MP -MF $@.d -o ${OBJECTDIR}/FileSystem/AllocatedBlocks.o FileSystem/AllocatedBlocks.cpp

${OBJECTDIR}/FileSystem/Block.o: FileSystem/Block.cpp 
	${MKDIR} -p ${OBJECTDIR}/FileSystem
	${RM} $@.d
	$(COMPILE.cc) -O2 -lmysqlcppconn -lboost_system -lboost_thread -lboost_serialization -MMD -MP -MF $@.d -o ${OBJECTDIR}/FileSystem/Block.o FileSystem/Block.cpp

${OBJECTDIR}/FileSystem/FileStream.o: FileSystem/FileStream.cpp 
	${MKDIR} -p ${OBJECTDIR}/FileSystem
	${RM} $@.d
	$(COMPILE.cc) -O2 -lmysqlcppconn -lboost_system -lboost_thread -lboost_serialization -MMD -MP -MF $@.d -o ${OBJECTDIR}/FileSystem/FileStream.o FileSystem/FileStream.cpp

${OBJECTDIR}/FileSystem/FileStreamRead.o: FileSystem/FileStreamRead.cpp 
	${MKDIR} -p ${OBJECTDIR}/FileSystem
	${RM} $@.d
	$(COMPILE.cc) -O2 -lmysqlcppconn -lboost_system -lboost_thread -lboost_serialization -MMD -MP -MF $@.d -o ${OBJECTDIR}/FileSystem/FileStreamRead.o FileSystem/FileStreamRead.cpp
...
${OBJECTDIR}/Network/UdpBroatcast.o: Network/UdpBroatcast.cpp 
	${MKDIR} -p ${OBJECTDIR}/Network
	${RM} $@.d
	$(COMPILE.cc) -O2 -lmysqlcppconn -lboost_system -lboost_thread -lboost_serialization -MMD -MP -MF $@.d -o ${OBJECTDIR}/Network/UdpBroatcast.o Network/UdpBroatcast.cpp
...
${OBJECTDIR}/redis/RedisConnection.o: redis/RedisConnection.cpp 
	${MKDIR} -p ${OBJECTDIR}/redis
	${RM} $@.d
	$(COMPILE.cc) -O2 -lmysqlcppconn -lboost_system -lboost_thread -lboost_serialization -MMD -MP -MF $@.d -o ${OBJECTDIR}/redis/RedisConnection.o redis/RedisConnection.cpp

${OBJECTDIR}/redis/anet.o: redis/anet.cpp 
	${MKDIR} -p ${OBJECTDIR}/redis
	${RM} $@.d
	$(COMPILE.cc) -O2 -lmysqlcppconn -lboost_system -lboost_thread -lboost_serialization -MMD -MP -MF $@.d -o ${OBJECTDIR}/redis/anet.o redis/anet.cpp
