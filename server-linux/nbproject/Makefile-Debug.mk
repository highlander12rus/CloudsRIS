...
${OBJECTDIR}/Exception/MaxSearchPort.o: Exception/MaxSearchPort.cpp 
	${MKDIR} -p ${OBJECTDIR}/Exception
	${RM} $@.d
	$(COMPILE.cc) -g -lmysqlcppconn -lboost_system -lboost_thread -lboost_serialization -lboost_filesystem -lboost_signals -MMD -MP -MF $@.d -o ${OBJECTDIR}/Exception/MaxSearchPort.o Exception/MaxSearchPort.cpp
...
${OBJECTDIR}/Network/SearchServer.o: Network/SearchServer.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -lmysqlcppconn -lboost_system -lboost_thread -lboost_serialization -lboost_filesystem -lboost_signals -MMD -MP -MF $@.d -o ${OBJECTDIR}/Network/SearchServer.o Network/SearchServer.cpp
