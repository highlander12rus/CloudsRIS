...
${OBJECTDIR}/Event/EventListend.o: Event/EventListend.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -lmysqlcppconn -lboost_system -lboost_thread -lboost_serialization -lboost_filesystem -MMD -MP -MF $@.d -o ${OBJECTDIR}/Event/EventListend.o Event/EventListend.cpp

${OBJECTDIR}/Event/UdpBrotcastEventListener.o: Event/UdpBrotcastEventListener.cpp 
	${MKDIR} -p ${OBJECTDIR}/Event
	${RM} $@.d
	$(COMPILE.cc) -g -lmysqlcppconn -lboost_system -lboost_thread -lboost_serialization -lboost_filesystem -MMD -MP -MF $@.d -o ${OBJECTDIR}/Event/UdpBrotcastEventListener.o Event/UdpBrotcastEventListener.cpp
