...
namespace Network {
    namespace Tcp {
        ...
        public:
             ...
             */
            TcpServerDownload(boost::asio::io_service* io_service, Config* config, 
        ...
        private:
             ...
             * @param error
             */
            void handle_accept(Download::pointer new_connection,
