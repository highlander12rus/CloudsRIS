...
namespace Network {
    namespace Tcp {
        ...
        public:
             ...
             */
            TcpServerUpload(boost::asio::io_service* io_service, Config* config, 
        ...
        private:
             ...
             * @param error
             */
            void handle_accept(Upload::pointer new_connection,
