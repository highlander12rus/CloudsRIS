...
namespace Network {
    namespace Tcp {
        ...
        public:
             ...
             */
            TcpServerBackup(boost::asio::io_service* io_service, Config* config, 
        ...
        private:
             ...
             * @param error
             */
            void handle_accept(Backup::pointer new_connection,
